 ...
 * (the same trade-off those classes document). Used for the stored-bytes hash (Principle III) and the
 * extracted-text / summary hashes recorded in the reproducibility snapshot (Principle II).
 */
