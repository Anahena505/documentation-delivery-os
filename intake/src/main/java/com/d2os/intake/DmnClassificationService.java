 ...
 * confirm step (FR-002).
 *
 * <p>Resilient by design: if the decision engine returns no row (e.g. an unmapped request type), it
 * falls back to the sole Phase-1 case type ({@code initiation}) at low confidence, which forces
...
public class DmnClassificationService implements ClassificationService {
  ...
  public DmnClassificationService(
