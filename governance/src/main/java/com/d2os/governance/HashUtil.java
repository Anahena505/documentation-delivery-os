 ...
 * artifacts.HashUtil} rather than shared, matching this repo's existing precedent (those two
 * classes' own javadocs document the same trade-off) — a ~20-line pure function doesn't justify a
 * new shared module or a cross-module dependency just for this.
 */
