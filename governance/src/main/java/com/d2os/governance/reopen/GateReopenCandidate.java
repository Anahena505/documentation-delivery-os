...
public class GateReopenCandidate {
    ...
    public enum Disposition { PENDING, REOPENED, MANUAL_REVIEW, DISMISSED }
    ...
    public GateReopenCandidate(UUID id, UUID workspaceId, UUID upstreamArtifactRevisionId,
                               UUID dependentArtifactRevisionId, UUID gateInstanceId, int depth,
    ...
    public UUID getUpstreamArtifactRevisionId() { return upstreamArtifactRevisionId; }
    public UUID getDependentArtifactRevisionId() { return dependentArtifactRevisionId; }
    public UUID getGateInstanceId() { return gateInstanceId; }
    public int getDepth() { return depth; }
    public Disposition getDisposition() { return Disposition.valueOf(disposition); }
