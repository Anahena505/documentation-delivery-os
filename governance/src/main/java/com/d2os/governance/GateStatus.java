 ...
 * APPROVE/REJECT/REQUEST_CHANGES; the APPROVED → REOPEN_CANDIDATE edge is driven by {@code
 * ReopenCandidateService} (Phase 5, US3) identifying a direct dependent of a revised upstream
...
public enum GateStatus {
  ...
  private static final Map<GateStatus, Set<GateStatus>> ALLOWED =
      Map.of(
