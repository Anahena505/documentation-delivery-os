...
public class EscalationController {
    ...
    public record EscalationActivationView(UUID id, UUID gateInstanceId, String policyKey, int policyVersion,
                                           int stepIndex, String role, boolean assigneeResolved, String status,
                                           OffsetDateTime firedAt) {
        static EscalationActivationView of(EscalationActivation a) {
            return new EscalationActivationView(a.getId(), a.getGateInstanceId(), a.getPolicyKey(), a.getPolicyVersion(),
                    a.getStepIndex(), a.getRole(), a.isAssigneeResolved(), a.getStatus(), a.getFiredAt());
        }
    }
}
