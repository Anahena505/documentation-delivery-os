...
public class HandoverRecord {
  ...
  public HandoverRecord(
      UUID id,
      UUID workspaceId,
      UUID executionPackageId,
      String contentsIndex,
      UUID submissionRef,
  ...
  public UUID getSubmissionRef() {
    return submissionRef;
  }

  public UUID getDefinitionSnapshotRef() {
    return definitionSnapshotRef;
  }

  public String getArtifactHashes() {
    return artifactHashes;
  }

  public String getDecisionLogRef() {
    return decisionLogRef;
  }
