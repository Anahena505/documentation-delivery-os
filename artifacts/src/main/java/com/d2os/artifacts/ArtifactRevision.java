...
/**
 * A content-addressed revision of an Artifact (E1.7, R8). Corrections are new revisions, never
 * in-place edits.
 */
@Entity
...
public class ArtifactRevision {
  ...
  public ArtifactRevision(
    ...
    this(
        ...
        storageRef,
        contentHash,
        producedByOperationExecutionId,
        null,
        null);
  }
  ...
  public UUID getProducedByOperationExecutionId() {
    return producedByOperationExecutionId;
  }
