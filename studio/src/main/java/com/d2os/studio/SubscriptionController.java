...
public class SubscriptionController {
    ...
    public ResponseEntity<SubscriptionResultView> subscribe(@PathVariable UUID definitionId,
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new SubscriptionResultView(
                copy.getId(), copy.getKey(), copy.getVersion(), copy.getCopiedFromId(), result.checksumVerified()));
    }

    public record SubscriptionResultView(UUID definitionId, String key, String version,
                                         UUID copiedFromId, boolean checksumVerified) {}
}
