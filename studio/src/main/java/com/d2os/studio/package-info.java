 ...
 * live as services in {@code catalog} so they stay API-testable without this UI layer — an ArchUnit
 * rule (Phase 8, T031) later enforces that those services take no dependency back on this package.
 *
 ...
 * SubscriptionController} (T026). This package-info exists only so Gradle/Java recognize the module
 * before any of that code lands (T001).
 */
