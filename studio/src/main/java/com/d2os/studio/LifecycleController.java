...
public class LifecycleController {
  ...
  public ResponseEntity<Map<String, Object>> fork(
    ...
    DefinitionAsset forked =
        forkService.fork(definitionId, newVersion, WorkspaceContext.require(), actor);
  ...
  public ResponseEntity<Map<String, Object>> deprecationImpact(@PathVariable UUID definitionId) {
    ...
    return ResponseEntity.ok(
        Map.of(
            ...
            report.version(),
            "pinnedActiveCases",
            report.pinnedActiveCases(),
            "dependents",
            report.dependents(),
            "subscriptionCopies",
            report.subscriptionCopies(),
            "totalImpact",
            report.totalImpact()));
  }
  ...
  public ResponseEntity<Map<String, Object>> deprecate(
    ...
    if (request == null || request.get("impactReportId") == null) {
      return ResponseEntity.status(HttpStatus.CONFLICT)
          .body(
              Map.of(
                  "error", "impactReportId is required — call GET .../deprecation-impact first"));
    }
    DefinitionAsset def =
