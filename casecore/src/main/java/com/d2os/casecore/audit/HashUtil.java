 ...
 * repo's existing precedent ({@code governance.HashUtil}/{@code artifacts.HashUtil} document the
 * same trade-off): a ~20-line pure function doesn't justify a cross-module dependency just for
 * this.
 */
