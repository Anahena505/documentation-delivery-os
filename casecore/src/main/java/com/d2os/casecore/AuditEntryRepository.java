...
public interface AuditEntryRepository extends JpaRepository<AuditEntryRecord, UUID> {
  List<AuditEntryRecord> findBySubjectTypeAndSubjectIdOrderByTxTimeAsc(
  ...
  List<AuditEntryRecord> findByWorkspaceIdAndTxTimeAfterOrderByTxTimeAscIdAsc(
      UUID workspaceId, OffsetDateTime after);
