 ...
 * (PD-1); it is rebuilt naturally as cases transition, and a restart simply resumes emitting once
 * the async jobs re-acquire. Avoiding a cross-tenant DB scan also sidesteps RLS on the scheduler
 * thread.
 */
@Component
