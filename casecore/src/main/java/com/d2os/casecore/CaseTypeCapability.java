...
/**
 * Reads the Phase 4 capability flags ({@code mutating}, {@code artifactKindAllowlist}) back out of
 * a pinned {@link CaseDefinitionSnapshot}'s {@code case_type} entry (research R2/R3; written by
 ...
 * with an empty allowlist — i.e. the pre-Phase-4 behavior (unrestricted mutating case) — so
 * existing case types are unaffected.
 */
