...
public class AuditEntryRecord {
  ...
  /**
   * Actor-stamped constructor (008 US5, T051). {@code actorUserId}/{@code actorRole} are null in
   * the default (workspace-scoping) posture, in which case this row is byte-identical, under {@link
