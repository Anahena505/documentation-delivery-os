...
public class PersonaInvocation {
  ...
  /**
   * BPMN branch (execution/activity id) for parallel-block steps; NULL for sequential steps (US2,
   * V11).
   */
  ...
  /**
   * The real persona key this invocation ran (e.g. security-architect); replaces persona-N
   * inference (V11).
   */
  ...
  public void markStatus(Status s) {
    this.status = s.name();
  }
