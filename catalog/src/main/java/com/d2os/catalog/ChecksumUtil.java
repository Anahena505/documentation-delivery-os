 ...
 * private {@code sha256} to delegate here: {@code DefinitionPublishService} is explicitly
 * untouched in this phase (Phase 1-2's design decision keeps it as {@code CatalogSeedLoader}'s
 * sole direct-publish primitive). Same "~20-line pure function, not worth a forced coupling"
 * trade-off {@code governance.HashUtil}'s own javadoc documents for the identical duplication.
 */
