...
/** Fetches a pinned (key,version) definition's full body — used by pipelines executing against a frozen snapshot (AD-4). */
@Service
public class DefinitionLookupService {
    ...
    public Optional<DefinitionView> byTypeKeyVersion(String type, String key, String version) {
        return repository.findByTypeAndKeyAndVersion(type, key, version)
