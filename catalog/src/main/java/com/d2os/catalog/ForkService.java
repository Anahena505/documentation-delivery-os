 ...
 * provenance; forking never mutates the source and never installs a runtime override — the result
 * is an ordinary Draft that must go through the normal submit-review/publish flow (Phase 6 US2)
 * like any other authored content before anything can ever resolve it.
 */
@Service
