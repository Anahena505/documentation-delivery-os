 ...
 * DefinitionAsset#markPublishedFromReview}'s own javadoc for why the module edge runs the other
 * way) — same "a ~20-line pure function doesn't justify a cross-module dependency" precedent {@code
