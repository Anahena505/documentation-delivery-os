 ...
 * NFR-9): 500 Published versions across the 8 definition types, through the REAL seed path — {@link
 * DraftService#create} then {@link DefinitionPublishService#publish} — the same two-step
...
public final class BenchmarkSeeder {
  ...
  public static void seed(
      ...
      DefinitionPublishService publishService,
      UUID workspaceId,
      int totalVersions,
      int keysPerType) {
