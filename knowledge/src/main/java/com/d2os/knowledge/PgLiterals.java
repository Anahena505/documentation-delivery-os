...
/**
 * Builds the two Postgres literal strings that JPA/JdbcTemplate cannot bind as typed params here: a
 * {@code vector} literal for pgvector and a {@code text[]} array literal. Both are bound as plain
...
final class PgLiterals {
  ...
  /**
   * Postgres {@code text[]} array literal: {@code {"tag1","tag2"}}, each element quoted and
   * escaped.
   */
