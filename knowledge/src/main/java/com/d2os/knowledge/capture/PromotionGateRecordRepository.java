...
/**
 * Append-only reads over {@link PromotionGateRecord}. Gate-order and at-most-one-PASS invariants
 * are checked in {@link PromotionGateService} against these reads (belt) and enforced by the DB
 * partial unique index (braces).
 */
