...
/**
 * A derived graph edge (V28, data-model.md GraphEdge, research R1-R3/R7). Never authored directly —
 * see {@link GraphNode}'s javadoc for the sole-writer contract this shares.
 *
