 ...
 * event_outbox.seq} (V28's ALTER on casecore's event_outbox table) this consumer has processed per
 * workspace; a rebuild (T009, a later phase) ignores this and replays from zero.
 */
@Entity
...
public class ProjectionCheckpoint {
  ...
  public ProjectionCheckpoint(
      String consumer, UUID workspaceId, long outboxWatermark, OffsetDateTime updatedAt) {
